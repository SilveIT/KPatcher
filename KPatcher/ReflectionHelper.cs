...
namespace KPatcher
{
    ...
    public class ReflectionHelper
    {
        ...
        public ReflectionHelper(bool verbose = false)
        {
            Verbose = verbose;
        ...
        public class Types : ReflectionAccess
        {
            ...
            public Types(ReflectionHelper helper) : base(helper) { }
        }
        ...
        public class Properties : ReflectionAccess
        {
            ...
            public Properties(ReflectionHelper helper) : base(helper) { }
        }
        ...
        public class Fields : ReflectionAccess
        {
            ...
            public Fields(ReflectionHelper helper) : base(helper) { }
        }
        ...
        public class Methods : ReflectionAccess
        {
            ...
            public Methods(ReflectionHelper helper) : base(helper) { }
        }

        public abstract class ReflectionAccess
        {
            internal ReflectionHelper Reflection;

            protected ReflectionAccess(ReflectionHelper helper) => Reflection = helper;
        }
    }
